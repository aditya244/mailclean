    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          gap: '16px',
          marginBottom: displayCount > 0 && stats.totalCleaned > 0 ? '24px' : '0',
        }}>
          {[
        ...
        {/* Progress bar */}
        {displayCount > 0 && stats.totalCleaned > 0 && (
          <div>
            ...
            <div style={{ width: '100%', backgroundColor: '#f3f4f6', borderRadius: '999px', height: '8px' }}>
              <div style={{
                width: `${Math.min((stats.totalCleaned / displayCount) * 100, 100)}%`,
            ...
            <p style={{ fontSize: '12px', color: '#9ca3af', marginTop: '8px', marginBottom: '0' }}>
              {((stats.totalCleaned / displayCount) * 100).toFixed(1)}% of your inbox cleaned
              {stats.totalCleaned < displayCount && (
                <span style={{ color: '#6366f1', marginLeft: '8px', fontWeight: '500' }}>
                  — {(displayCount - stats.totalCleaned).toLocaleString()} more to go
                </span>
              )}
            </p>
          </div>
