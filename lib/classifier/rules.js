...
export function classifyByRules(email) {
  ...
  // Priority 0: OTP — always highest priority
  if (isOTPEmail(subject)) {
    return { category: 'OTP & Security', confidence: 0.97, reason: 'OTP pattern in subject' }
  }

  // Priority 0.5: Bank promotional — check before domain lookup
  // Prevents finance domains from swallowing promotional emails
